...
func (a *cLogin) ShowLoginForm(t template.Template, data template.Data, captcha captcha.Captcha) {
	data["Captcha"] = captcha.HTML()
	t.HTML(http.StatusOK, "auth/login")
}

func (a *cLogin) Login(c flamego.Context, captcha captcha.Captcha) {
