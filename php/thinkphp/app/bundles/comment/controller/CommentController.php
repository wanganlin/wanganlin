...
namespace app\bundles\comment\controller;

use app\api\admin\controller\BaseController;
use app\bundles\comment\entity\CommentEntity;
use app\bundles\comment\request\comment\CommentCreateRequest;
use app\bundles\comment\request\comment\CommentQueryRequest;
use app\bundles\comment\request\comment\CommentUpdateRequest;
use app\bundles\comment\response\comment\CommentQueryResponse;
use app\bundles\comment\response\comment\CommentResponse;
...
{
    #[OA\Post(path: '/comment/query', summary: '查询列表接口', security: [['bearerAuth' => []]], tags: ['评论模块'])]
    ...
    #[OA\Post(path: '/comment/create', summary: '新增接口', security: [['bearerAuth' => []]], tags: ['评论模块'])]
    ...
    public function create(): Response
    {
        ...
        try {
            ...
            $commentBundleService = new CommentBundleService;
            $insertId = $commentBundleService->save($commentEntity->toEntity());
            if ($insertId > 0) {
                DB::commit();
    ...
    #[OA\Get(path: '/comment/show', summary: '获取详情接口', security: [['bearerAuth' => []]], tags: ['评论模块'])]
    ...
    #[OA\Put(path: '/comment/update', summary: '更新接口', security: [['bearerAuth' => []]], tags: ['评论模块'])]
    ...
    public function update(): Response
    {
        ...
        try {
            ...
            $commentBundleService->update($commentEntity->toEntity(), [
                ['id', '=', $request['id']],
            ]);
    ...
    #[OA\Delete(path: '/comment/destroy', summary: '删除接口', security: [['bearerAuth' => []]], tags: ['评论模块'])]
    #[OA\Parameter(name: 'id', description: 'ID', in: 'query', required: true, example: 1)]
    #[OA\Response(response: 200, description: 'OK')]
