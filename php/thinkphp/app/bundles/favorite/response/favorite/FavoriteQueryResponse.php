...
#[OA\Schema(schema: 'FavoriteQueryResponse')]
class FavoriteQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: FavoriteResponse::class))]
    private array $data;
