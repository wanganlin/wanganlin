...
#[OA\Schema(schema: 'DictQueryResponse')]
class DictQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: DictResponse::class))]
    private array $data;
