...
namespace app\bundles\user\controller;

use app\api\admin\controller\BaseController;
use app\bundles\user\entity\UserEntity;
use app\bundles\user\request\user\UserCreateRequest;
use app\bundles\user\request\user\UserQueryRequest;
use app\bundles\user\request\user\UserUpdateRequest;
use app\bundles\user\response\user\UserQueryResponse;
use app\bundles\user\response\user\UserResponse;
...
class UserController extends BaseController
{
    ...
    public function create(): Response
    {
        ...
        try {
            ...
            $userBundleService = new UserBundleService;
            $insertId = $userBundleService->save($userEntity->toEntity());
            if ($insertId > 0) {
                DB::commit();
    ...
    public function update(): Response
    {
        ...
        try {
            ...
            $userBundleService->update($userEntity->toEntity(), [
                ['id', '=', $request['id']],
            ]);
