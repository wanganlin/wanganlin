...
#[OA\Schema(schema: 'BannerPositionQueryResponse')]
class BannerPositionQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: BannerPositionResponse::class))]
    private array $data;
