...
#[OA\Schema(schema: 'BannerQueryResponse')]
class BannerQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: BannerResponse::class))]
    private array $data;
