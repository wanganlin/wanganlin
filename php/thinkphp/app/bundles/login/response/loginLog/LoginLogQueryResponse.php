...
#[OA\Schema(schema: 'LoginLogQueryResponse')]
class LoginLogQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: LoginLogResponse::class))]
    private array $data;
