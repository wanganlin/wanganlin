...
#[OA\Schema(schema: 'SystemAdminQueryResponse')]
class SystemAdminQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemAdminResponse::class))]
    private array $data;
