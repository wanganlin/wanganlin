...
#[OA\Schema(schema: 'SystemAdminRoleQueryResponse')]
class SystemAdminRoleQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SystemAdminRoleResponse::class))]
    private array $data;
