...
#[OA\Schema(schema: 'AttachmentCategoryQueryResponse')]
class AttachmentCategoryQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AttachmentCategoryResponse::class))]
    private array $data;
