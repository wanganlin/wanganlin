...
#[OA\Schema(schema: 'SettingQueryResponse')]
class SettingQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SettingResponse::class))]
    private array $data;
