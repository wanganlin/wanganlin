...
use app\api\admin\request\auth\ForgetRequest;
use app\api\admin\request\auth\LoginRequest;
use app\api\admin\response\auth\LoginResponse;
use app\logic\SystemAdminService;
...
class AuthController extends Controller
{
    ...
    public function login(Request $request): Json
    {
        try {
            ...
            if ($systemAdminService->login($formData['username'], $formData['password'], $formData['remember'] === 'on')) {
