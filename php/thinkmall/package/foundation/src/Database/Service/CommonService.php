...
namespace Juling\Foundation\Database\Service;

use app\exception\CustomException;
use Juling\Foundation\Database\Contract\CommonServiceInterface;
use Juling\Foundation\Database\Contract\CurdRepositoryInterface;
